...
from graphics.graphics_3d.sphere import area as sphere_area, perimeter as sphere_peri

# Rectangle
l = float(input("Enter length of rectangle: "))
b = float(input("Enter breadth of rectangle: "))
print("Rectangle Area:", rect.area(l, b))
print("Rectangle Perimeter:", rect.perimeter(l, b))
...
print("Cuboid Perimeter:", cuboid.perimeter(l, b, h))
